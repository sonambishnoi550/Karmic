                ...
                <div className='lg:flex-row flex-col flex justify-between xl:pt-[143px] pt-[120px] max-lg:py-20 max-sm:py-10 gap-5'>
                    <div className='lg:w-[570px] w-full flex flex-col justify-center'>
                        <div className='flex flex-col justify-center max-lg:items-center'>
                            ...
                            <p className='font-normal leading-custom-2xl text-base max-w-[570px] text-white pt-3'>Vulputate tristique habitant neque, accumsan. Vitae ultrices nulla erat nibh aliquam, quis tempus volutpat arcu. Leo convallis luctus dis malesuada turpis non consequat ac. </p>
