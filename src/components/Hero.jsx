                ...
                <div className='lg:flex-row flex-col flex justify-between lg:pt-[173px] max-lg:py-20 max-sm:py-12 gap-5'>
                    <div className='lg:w-[570px] w-full flex flex-col justify-center'>
                        <div className='flex flex-col justify-center max-lg:items-center'>
                            <h1 className='lg:text-custom-5xl lg:leading-custom-5xl sm:text-5xl sm:leading-custom-4xl text-4xl text-white uppercase lg:max-w-[570px] max-lg:text-center'>We are believers decentralization <img className='ms-[167px] -mt-2 max-w-[158px] w-full lg:block hidden' src="./assets/images/svg/hero-line.svg" alt="second-line" /> And Web3.
                            ...
                            <div className='flex  sm:pt-10 pt-5 sm:gap-8 gap-5'>
                                ...
                                <CustomButton text="Read More" classStyle="!py-[9.2px] !px-[31px] font-thin bg-transparent text-white border border-white hover:bg-gray-500 hover:!bg-white hover:text-black transition-all duration-500" />
                            </div>
